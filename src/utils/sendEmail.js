...
class SendEmail {
  ...
  * @returns {boolean} specifies if the email was sent successfully
  */
  static sendEmailNotificationForEditedRequest(notificationDetails) {
    const emailParams = SendEmail.editedTripData(notificationDetails);
    const details = {
      email: emailParams.email,
      subject: 'Edited Request - BareFoot-Nomad',
      html: `'<div style="width: 90%; margin: 5em auto;
      box-shadow: 0 0 10px rgba(0,0,0,.9);">
      <div>
        <div>
          ...
          <h1 style="text-align: center">Hi! ${emailParams.requesterName}</h1>
        </div>
        <div style=" padding: 0px 20px 20px 20px">
          <div>
            <p>You recently edited this request with the id: <strong>${emailParams.requestId}</strong>number.</p>
            <p>Below are the details of the request:</p></br>
            <ul>
              <li>Origin: ${emailParams.origin}</li>
              <li>Destination: ${emailParams.destination}</li>
            ...
            <button style="color: white; background-color: #1AC124;
              border: none; border-radius: 10px; text-align: center;
              padding: 10px;">
              <a  href="${baseUrl}/request/view/${emailParams.requestId}"
                style="text-decoration: none;
                color: white;">View Request</a>
              </button>
          <div>
            <h3 style="text-align: center">Thank you</h3>
            <h3 style="text-align: center">
  ...
  */
  ...
  /**
     ...
     * @returns {object} Object containing data for sending mail
     */
  static editedTripData({
    user, updatedRequest, type
  }) {
    return {
      email: user.email,
      ...
      flightDate: updatedRequest.flightDate,
